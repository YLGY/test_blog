                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{ asset('15_blog_details.html') }}">{{ $third_post->title }}</a>
                                    </h2>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $outdoor->name }}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach ($outdoor_posts as $outdoor_post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $outdoor_post->featured }}"alt="our case">
                                        </div>
                                        <h6 class="case-item__title text-center"><a href="{{ route('post.single', ['slug' => $outdoor_post->slug]) }}">{{ $outdoor_post->title}}</a></h6>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $helloworld->name }}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                        ...
                        <div class="case-item-wrap">
                            @foreach ($helloworld_posts as $helloworld_post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $helloworld_post->featured }}"alt="our case">
                                        </div>
                                        <h6 class="case-item__title text-center"><a href="{{ route('post.single', ['slug' => $helloworld_post->slug]) }}">{{ $helloworld_post->title }}</a></h6>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="row">
                <div class="subscribe scrollme">
                    <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                        ...
                        <form class="subscribe-form" method="post" action="/subcribed">
                            @csrf
        ...
        <div class="row">
            <div class="form_search-wrap">
                <form method="GET" action="/results">
                    ...
                    <a href="{{ asset('#') }}"class="overlay_search-close">
                        <span></span>
                        <span></span>
                    </a>
                </form>
